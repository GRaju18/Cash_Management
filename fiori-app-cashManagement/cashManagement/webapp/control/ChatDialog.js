sap.ui.define(
	["sap/ui/core/Control",
		...
		"com/9b/flowering/control/ChatBotInput"
	],
	function (Control, Button, IconPool, Dialog, List, FeedListItem, FeedInput, ResponsivePopover, VBox, ScrollContainer, Bar, Title,
		...
		var ChatDialog = Control.extend("com.9b.flowering.control.ChatDialog", {
			...
			init: function () {
				...
				var libraryPath = jQuery.sap.getModulePath("com.9b.flowering");
