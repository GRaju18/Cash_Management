sap.ui.define([
	...
	return UIComponent.extend("com.9b.cashManagement.Component", {
		...
		_getDialog: function () {
			if (!this.dialog) {
				...
				this.dialog = sap.ui.xmlfragment("sessionDialog", "com.9b.cashManagement.view.fragments.SessionTimeoutDialog", this);
			}
			return this.dialog;
		},
